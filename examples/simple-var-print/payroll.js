...
// END RUNTIME
let who = _valueFromVarSpec({
  length: 15,
  name: "who",
  type: "string",
})
let where = _valueFromVarSpec({
  length: 20,
  name: "where",
  type: "string",
})
let why = _valueFromVarSpec({
  length: 30,
  name: "why",
  type: "string",
})
let rate = _valueFromVarSpec({
  length: 3,
  name: "rate",
  type: "string",
})
let hours = _valueFromVarSpec({
  length: 3,
  name: "hours",
  type: "string",
})
let grossPay = _valueFromVarSpec({
  length: 5,
  name: "grossPay",
  type: "string",
})
